...
from .types import Tree, Vec2, Vec3, Vector

inf = float("inf")


def axes() -> Vec3:
    """Get the standard x, y, and z axes as a Vector"""
    return Vec3(Tree.x(), Tree.y(), Tree.z())


def axes2d() -> Vec2:
    """Get the standard x, and y axes as a Vector"""
    return Vec2(Tree.x(), Tree.y())
